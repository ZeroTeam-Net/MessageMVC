...
namespace ZeroTeam.MessageMVC.ZeroApis
{
    ...
    {
        private static IMessageReceiver RpcTransportBuilder(string name) => DependencyHelper.GetService<IServiceReceiver>();
        private static IMessageReceiver ConsumerTransportBuilder(string name) => DependencyHelper.GetService<IMessageConsumer>();
        private static IMessageReceiver NetEventTransportBuilder(string name) => DependencyHelper.GetService<INetEvent>();
