...
function showIframe(url) {
    ...
    try {
        ...
        //ws.contentWindow.window.document.write("");//清空iframe的内容
...
function onLogout() {
    vueObject.$confirm('你确定要退出系统并后退到登录页面吗?', '退出登录', {
...
function changeEnter() {
    ...
    doOperator("修改密码", "/Api/Data.aspx?action=m",
        {
