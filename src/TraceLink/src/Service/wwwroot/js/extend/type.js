...
var appClassifyType = [
    { value: 0, text: '无权限' },
    { value: 1, text: '本企业私有应用' },
    { value: 2, text: '外企业私有应用' },
    { value: 3, text: '互联网公众应用' }
];
 ...
 * @returns {string} 文本
 */
function appClassifyTypeFormat(value) {
    return arrayFormat(value, appClassifyType);
}
 ...
 * @returns {string} 文本
 */
function appFeatureTypeFormat(value) {
    return arrayFormat(value, appFeatureType);
}