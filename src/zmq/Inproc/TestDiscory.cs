        ...
        {
            {
                ...
                if (ia != null)
                {
                    MessageProducer.Register(ia.Name, InporcProducer.Instance);
                    name = ia.Name;
            ...
            #region Api
            {
                ...
                if (sa != null)
                {
                    MessageProducer.Register(sa.Name, InporcProducer.Instance);
                    name = sa.Name;
                    return InprocTransportBuilder;
                }
            }
            ...
            #region MQ
            {
                ...
                if (ca != null)
                {
                    MessageProducer.Register(ca.Topic, InporcProducer.Instance);
                    name = ca.Topic;
                    return InprocTransportBuilder;
                }
            }
            ...
            #region NetEvent
            {
                ...
                if (na != null)
                {
                    MessageProducer.Register(na.Name, InporcProducer.Instance);
                    name = na.Name;
                    return InprocTransportBuilder;
                }
            }
